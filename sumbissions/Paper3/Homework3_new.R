...
ggplot(Guj3_6, aes(x = productivitynonfarm, y = compensationnonfarm)) +
  geom_point() +
  labs(x = "productivity", y = "compensation",
       title = "Relationship between compensation and real GDP output in nonfamrm sector") +
  geom_smooth(method = "lm", se = FALSE)
